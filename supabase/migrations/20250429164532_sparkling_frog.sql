...
VALUES 
  ...
  ('Tailwind CSS', 'Modern CSS framework', 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg', 'Frontend'),
  ('Redis', 'In-memory veri depolama', 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/redis/redis-original.svg', 'Database'),
  ('Kubernetes', 'Konteyner orkestrasyon', 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-plain.svg', 'DevOps'),
  ('VS Code', 'Kod editörü', 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg', 'Tools')
